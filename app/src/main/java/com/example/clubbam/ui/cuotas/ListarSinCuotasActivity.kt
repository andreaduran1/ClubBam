...
class ListarSinCuotasActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_listar_sin_cuotas)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.listarSinCuotas)) { v, insets ->
